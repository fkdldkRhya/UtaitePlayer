 ...
 *
 */
class StickyHeaderItemDecoration(sectionCallback: SectionCallback) : RecyclerView.ItemDecoration() {
    private val callback: SectionCallback = sectionCallback
    ...
    override fun onDrawOver(c: Canvas, parent: RecyclerView, state: RecyclerView.State) {
        ...
        val currentHeader: View =
                callback.getHeaderLayoutView(parent, topChildPosition) ?: return
        ...
        if (callback.isSection(childAdapterPosition)) {
